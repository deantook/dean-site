import{_ as a}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as n,d as e}from"./app.7628e15f.js";const r={},i=e(`<h1 id="docker-的安装以及常用组件的部署" tabindex="-1"><a class="header-anchor" href="#docker-的安装以及常用组件的部署" aria-hidden="true">#</a> Docker 的安装以及常用组件的部署</h1><h2 id="docker-的安装" tabindex="-1"><a class="header-anchor" href="#docker-的安装" aria-hidden="true">#</a> Docker 的安装</h2><h3 id="centos-安装-docker" tabindex="-1"><a class="header-anchor" href="#centos-安装-docker" aria-hidden="true">#</a> CentOS 安装 Docker</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum remove <span class="token function">docker</span> <span class="token punctuation">\\</span>
